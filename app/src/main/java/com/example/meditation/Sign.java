...
public class Sign extends AppCompatActivity {
    ...
    public void NextMain(View view) {
        ...
        {
            Toast.makeText(Sign.this, "Все обязательные поля должны быть заполнены!", Toast.LENGTH_SHORT).show();
        }
        else
        {
            ...
            {
                Toast.makeText(Sign.this, "Поле для Email должно обязательно содержать в себе символ '@'!", Toast.LENGTH_SHORT).show();
            }
        }
    }
    public void Login()
        ...
        call.enqueue(new Callback<MaskUsers>() {
            ...
            public void onResponse(Call<MaskUsers> call, Response<MaskUsers> response) {
                if (!response.isSuccessful()) {
                    Toast.makeText(Sign.this, "Пользователь с такой почтой и паролем не найден", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(response.body() != null)
                {
                    if(response.body().getToken() != null)
                    {
                        ...
                        Intent intent = new Intent(Sign.this, MainMenu.class);
                        Bundle b = new Bundle();
                        intent.putExtras(b);
            ...
            public void onFailure(Call<MaskUsers> call, Throwable t) {
                Toast.makeText(Sign.this, "При авторизации возникла ошибка: " + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
}