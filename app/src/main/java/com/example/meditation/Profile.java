...
public class Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AdapterBlock.DownloadImageTask((ImageView) image).execute(MainActivity.image);
    }
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        try {
                            ...
                            Stream.flush();
                            Stream.close();
                            Toast.makeText(Profile.this, "Успешное сохранение изображения!", Toast.LENGTH_LONG).show();
                        }
                        catch (Exception e)
                        {
                            e.printStackTrace();
                            Toast.makeText(Profile.this, "Возникла ошибка!", Toast.LENGTH_LONG).show();
                        }
                        ImgProfile();
                    }
                }
